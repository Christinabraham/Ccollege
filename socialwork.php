        ...
        <div class="row">
            <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item list-group-item-primary">ACADEMIC CALENDAR</li>
                    <li class="list-group-item list-group-item-primary">STUDENT ASSOCIATION</li>
                    <li class="list-group-item list-group-item-primary">STUDENT ACHEIVEMENTS</li>
                    <li class="list-group-item list-group-item-primary">ACTIVITIES AND EVENT</li>
                    <li class="list-group-item list-group-item-primary">PLACEMENT</li>
                    <li class="list-group-item list-group-item-primary">TIME TABLE</li>
                    
                  </ul>
            </div>
            <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <h5 style="font-family: 'Times New Roman', Times, serif;color: rgb(7, 7, 126);"> <b> DEPARTMENT OF SOCIAL WORK</b></h5>
                <P>
                    ...
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea fuga non, reprehenderit eum possimus, dicta dolore, illum ratione suscipit sint tempore. Maxime perferendis voluptate dolore voluptatibus, tempora tenetur velit culpa!
                </P>
            </div>
        </div>
        <div class="row">
