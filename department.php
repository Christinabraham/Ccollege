                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img height="700px" src="photos\download (3).jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Department of Computer Science</h5>
                          <p>EWING CHRISTIAN COLLEGE </p>
                        </div>
                      </div>
                      <div class="carousel-item">
                        <img height="700px" src="photos\download (4).jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img height="700px" src="photos\images (1).jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img height="700px" src="photos\download (6).jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
            ...
            <table class="table">
                <tr>
                    <td><div class="card" style="width: 18rem;">
                        <img height="200px" src="photos\images (6).jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <td><div class="card" style="width: 18rem;">
                        <img height="200px" src="photos\download (5).jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <td><div class="card" style="width: 18rem;">
                        <img height="200px" src="photos\images (7).jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                      ...
                      <td><div class="card" style="width: 18rem;">
                        <img height="200px" src="photos\images (8).jpg" class="card-img-top" alt="...">
                        <div class="card-body">
